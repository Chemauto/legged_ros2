/**
 * @file g1_wireless_controller.hpp
...
class G1WirelessController : public rclcpp::Node {
public:
    RCLCPP_SMART_PTR_DEFINITIONS(G1WirelessController)

    explicit G1WirelessController(
        const std::string & node_name = "g1_wireless_controller",
...
private:
    ...
    void wireless_controller_callback(const unitree_hg::msg::LowState::SharedPtr msg);
    rclcpp::Subscription<unitree_hg::msg::LowState>::SharedPtr wireless_controller_subscriber_;
