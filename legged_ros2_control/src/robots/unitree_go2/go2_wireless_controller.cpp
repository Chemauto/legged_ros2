/**
 * @file go2_wireless_controller.cpp
...
Go2WirelessController::Go2WirelessController(
    const std::string & node_name,
    const rclcpp::NodeOptions & options) : Node(node_name, options)
{
    wireless_controller_subscriber_ = this->create_subscription<unitree_go::msg::WirelessController>(
        "/wirelesscontroller", rclcpp::SensorDataQoS(),
        std::bind(&Go2WirelessController::wireless_controller_callback, this, std::placeholders::_1));
...
void Go2WirelessController::wireless_controller_callback(
    const unitree_go::msg::WirelessController::SharedPtr msg)
{
    BtnUnion btn_union;
    btn_union.value = msg->keys;
...
void Go2WirelessController::transfer_axes_()
{
...
void Go2WirelessController::transfer_btns_()
{
...
void Go2WirelessController::load_controller_bindings_()
{
...
void Go2WirelessController::request_controller_switch_(
...
void Go2WirelessController::wait_for_service_()
{
